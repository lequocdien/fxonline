...
const create = (req, res, next) => {
    ...
    execFunc('fn_add_account_staff($1::text, $2::text, $3::bool, $4::text, $5::text, $6::text, $7::date, $8::text, $9::text, $10::text, $11::text, $12::bool, $13::text, $14::integer)', [first_name, last_name, gender, email, phone, identity_card, issued_on, issued_by, address, user_name, password, status_acc, description, group_id])
        .then(data => {
...
const updateByAccountId = (req, res, next) => {
    ...
    execFunc('fn_update_account_staff($1::text, $2::text, $3::bool, $4::text, $5::text, $6::text, $7::date, $8::text, $9::text, $10::bool, $11::text, $12::integer, $13::integer)', [first_name, last_name, gender, email, phone, identity_card, issued_on, issued_by, address, status_acc, description, group_id, acc_id])
        .then(data => res.send(data))
        .catch(err => next(err));
}
...
const deleteByAccountId = (req, res, next) => {
    ...
    execFunc('fn_delete_account_staff($1::integer)', [acc_id])
        .then(data => res.send(data))
        .catch(err => next(err));
}
