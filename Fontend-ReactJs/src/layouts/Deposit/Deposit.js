...
import { Table, Card, Select, Row, Col, Input, Form, Button, Space } from 'antd';
...
export default function Deposit(props) {
    const { tradingAcc, depositReq } = props;
                        ...
                        <div className="page-header">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page"> Nạp tiền </li>
                                </ol>
                            </nav>
                        </div>
                        <div className="row">
